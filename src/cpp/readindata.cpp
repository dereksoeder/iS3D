...
// New public MUSIC version 3+1D format
void FO_data_reader::read_surf_VH_MUSIC_New_3pl1D(long length, FO_surf* surf_ptr, bool turn_on_bulk)
{
...
int PDG_Data::read_resonances_conventional(particle_info * particle, string pdg_filename)
{
  double eps = 1e-15;
  int Nparticle = 0;
  printf("Loading particle info from urqmd/smash pdg file '%s' (check that only 1 blank line at end of file)\n", pdg_filename.c_str());
